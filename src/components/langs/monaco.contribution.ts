import { languages, Emitter, IEvent, editor, Position, IRange } from 'monaco-editor/esm/vs/editor/editor.api';
import { Suggestions, EntityContext } from '@/parser/common/types';
