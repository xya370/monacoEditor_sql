...
} from '@/lib/clickhouse/ClickHouseParser';
import type { ClickHouseParserListener } from '@/lib/clickhouse/ClickHouseParserListener';
import { EntityContextType } from '../common/types';
import { StmtContextType, EntityCollector } from '../common/entityCollector';

export class ClickHouseEntityCollector extends EntityCollector implements ClickHouseParserListener {
   /** ====== Entity Begin */
